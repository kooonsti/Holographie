...
\begin{align*}
S_{\mathrm{res}}(\omega) =  S_0\cdot\mathrm{exp}\left[-4\ln(2)\cdot\left(\frac{\omega - \Omega}{\Delta\Omega}\right)^2\right] \cdot\sum_{n = 1}^{N} \delta(\omega - \Omega - n\cdot 2\pi a)
\end{align*} 
